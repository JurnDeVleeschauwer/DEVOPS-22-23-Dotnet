...
namespace Shared.FysiekeServers
{
    public interface IFysiekeServerService
    {
        ...
        Task<FysiekeServerResponse.GetDetail> GetDetailAsync(FysiekeServerRequest.GetDetail request); // admin can request all running VMs on a particular server
        ...
        Task<FysiekeServerResponse.GraphValues> GetGraphValueForServer(FysiekeServerRequest.Date date);
